...
= THIS FORK IS FOR A PRIVATE INSTALLATION OF BETTERMEANS.  Please go to https://github.com/bettermeans/bettermeans instead
...
All non-redmine code is Copyright (C) Shereef Bishay
